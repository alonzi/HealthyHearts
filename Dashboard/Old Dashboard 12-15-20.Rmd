...
ranges <- read_xlsx("variable_ranges.xlsx")
```
...
annotate_figure(plot, top = text_grob(paste0("Proportion of Normal & Abnormal Creatinine measurements over time"), 
...
##Sodium 170
```{r}
proportion_normal_bar("SODIUM170")$bar
proportion_normal_bar("SODIUM170")$name
proportion_normal_bar("SODIUM170")$table

boxplot_age("SODIUM170")

maxval_info(data.after.BD, "SODIUM170")

extval_info(data.after.BD, SODIUM170)

```
##Potassium
```{r}
proportion_normal_bar("POTASSIUM")$bar
proportion_normal_bar("POTASSIUM")$name
proportion_normal_bar("POTASSIUM")$table

boxplot_age("POTASSIUM")

maxval_info(data.after.BD, "POTASSIUM")

extval_info(data.after.BD, POTASSIUM)
